"""dynamic_generative_residual Configuration
...
from dynamic_generative_residual import settings
...
urlpatterns = [
    ...
    url(r'^Prediction_Of_Electricity_Theft_Detection/$', remoteuser.Prediction_Of_Electricity_Theft_Detection, name="Prediction_Of_Electricity_Theft_Detection"),
    ...
    url(r'^View_Predicted_Of_Electricity_Theft_Detection_Ratio/$', serviceprovider.View_Predicted_Of_Electricity_Theft_Detection_Ratio, name="View_Predicted_Of_Electricity_Theft_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Of_Electricity_Theft_Detection/$', serviceprovider.View_Predicted_Of_Electricity_Theft_Detection, name="View_Predicted_Of_Electricity_Theft_Detection"),
